...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'f1d0b26623544259afd03918b424503a',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '歐歐 oωo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '✍️隨手寫一些神奇冷知識/好用app分享', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://threads.o-w-o.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Threads, Notion, blog', // 网站关键词 英文逗号隔开
  ...
  RANDOM_IMAGE_URL: process.env.NEXT_PUBLIC_RANDOM_IMAGE_URL || 'https://cat-gpt.com/cats/gif', // 随机图片API,如果未配置下面的关键字，主页封面，头像，文章封面图都会被替换为随机图片
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '記錄一些之前寫過的各種內容', // 站点描述，被notion中的页面描述覆盖
